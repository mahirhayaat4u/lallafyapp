...
/// Skill Development Section — mirrors SkillDevelopment.jsx from lallafy.com
/// Controlled dynamically by Admin via SectionBanners (section === "skill") and DB products (isSkillDevelopment === true).
class SkillDevelopmentSection extends ConsumerWidget {
  const SkillDevelopmentSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bannersAsync = ref.watch(sectionBannersProvider);
    final productsAsync = ref.watch(skillProductsProvider);
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Toys that teach, inspire, and build future-ready skills.',
                      style: TextStyle(
                        fontFamily: 'Outfit',
                        fontSize: 13,
              ...
              GestureDetector(
                onTap: () => context.push('/shop?type=skill-development'),
                child: Padding(
        ...
        bannersAsync.when(
          data: (banners) {
            final skillBanner = banners.cast<SectionBanner?>().firstWhere(
                  (b) => b?.section == 'skill',
                  orElse: () => null,
                );

            return productsAsync.when(
              data: (products) => _buildGrid(context, skillBanner, products),
            ...
            GestureDetector(
              onTap: () {
                if (banner?.categoryId != null) {
                  ...
                  context.push('/shop?type=skill-development');
                }
              },
              child: Container(
                height: 185,
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            banner?.title ?? featuredProduct?.name ?? 'Skill Building Toys',
