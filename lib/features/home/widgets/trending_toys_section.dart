...
/// Trending Toys Section — mirrors TrendingToys.jsx from lallafy.com
/// Controlled dynamically by Admin via SectionBanners (section === "trending") and DB products (featured === true).
class TrendingToysSection extends ConsumerWidget {
  const TrendingToysSection({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "The hottest toys everyone's adding to their cart right now.",
                      style: TextStyle(
                        fontFamily: 'Outfit',
                        fontSize: 13,
              ...
              GestureDetector(
                onTap: () => context.push('/shop?sort=trending'),
                child: Padding(
        ...
        bannersAsync.when(
          data: (banners) {
            final trendingBanner = banners.cast<SectionBanner?>().firstWhere(
                  (b) => b?.section == 'trending',
                  orElse: () => null,
                );

            return productsAsync.when(
              data: (products) => _buildGrid(context, trendingBanner, products),
            ...
            GestureDetector(
              onTap: () {
                if (banner?.categoryId != null) {
                  ...
                  context.push('/shop?sort=trending');
                }
              },
              child: Container(
                height: 185,
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            banner?.title ?? featuredProduct?.name ?? 'Trending Toys Collection',
