...
/// Musical Toys Section — mirrors MusicalToys.jsx from lallafy.com
/// Controlled dynamically by Admin via SectionBanners (section === "musical") and DB products (isMusical === true).
class MusicalToysSection extends ConsumerWidget {
  const MusicalToysSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bannersAsync = ref.watch(sectionBannersProvider);
    final productsAsync = ref.watch(musicalProductsProvider);
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Let your little rockstars discover the joy of music.',
                      style: TextStyle(
                        fontFamily: 'Outfit',
                        fontSize: 13,
              ...
              GestureDetector(
                onTap: () => context.push('/shop?type=musical'),
                child: Padding(
        ...
        bannersAsync.when(
          data: (banners) {
            final musicalBanner = banners.cast<SectionBanner?>().firstWhere(
                  (b) => b?.section == 'musical',
                  orElse: () => null,
                );

            return productsAsync.when(
              data: (products) => _buildGrid(context, musicalBanner, products),
            ...
            GestureDetector(
              onTap: () {
                if (banner?.categoryId != null) {
                  ...
                  context.push('/shop?type=musical');
                }
              },
              child: Container(
                height: 185,
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            banner?.title ?? featuredProduct?.name ?? 'Musical Instruments & Toys',
